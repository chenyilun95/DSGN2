# Data augmentor for monocular data_dict.

from functools import partial
import numpy as np

from pcdet.utils import common_utils, box_utils
from . import augmentor_utils, mono_database_sampler
from .mono_augmentor_utils import flip_horizontal_mono

class MonoDataAugmentor(object):
    ...
    def random_flip(self, data_dict, config=None):
        ...
        if 'completion_points' in data_dict:
            data_dict['left_img'], data_dict['gt_boxes'], data_dict['points'], data_dict['completion_points'] = flip_horizontal_mono(
                data_dict['calib'], 
                data_dict['left_img'], 
                data_dict['gt_boxes'],
                data_dict['points'], 
                data_dict['completion_points']
            )
        else:
            data_dict['left_img'], data_dict['gt_boxes'], data_dict['points'], _ = flip_horizontal_mono(
                data_dict['calib'], 
                data_dict['left_img'], 
                data_dict['gt_boxes'],
                data_dict['points']
